<?php 
	...
	if($id == '' || $name =='' || $masp == '' || $price =='' || $category =='') {		
		...
		$sql = "UPDATE tbl_product_sale SET name='$name', masp='$masp', price='$price', image='$image',category='$category'   WHERE id='$id'";
	}
	...
	echo '
		<script type="text/javascript">
			...
			window.location.href="http://localhost/mudcappro/admin/?page=list_product_sale";
		</script>';
;?>